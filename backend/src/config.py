...
class ServiceConfig(BaseSettings):
    ...
    def metrics_to_publish(self) -> Dict[str, str]:
        return {
            ...
            "Load Voltage L1": "load_voltage_l1",
            "Load Voltage L2": "load_voltage_l2",
            "Load Voltage L3": "load_voltage_l3",
            "Load L1 Power": "load_power_l1",
            "Load L2 Power": "load_power_l2",
            "Load L3 Power": "load_power_l3",
